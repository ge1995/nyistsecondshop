...
<div class="container" style="position: relative; transform: translate(0,0)">
    <div class="col-md-9" style="float: left;">
        ...
        <div class="col-md-12 r2"
            ...
            <form:form method="post" commandName="user" items="${user}" id="register" enctype="multipart/form-data">
                <div class="col-md-12" style="padding-left: 0px; padding-bottom: 10px">
                    <div class="col-md-8" style="padding-left: 0px; padding-top: 50px">
                        ...
                        <input id="photo" style="margin-top: 10px" type="file" name="photo" onchange="change(event)"></input>
                    </div>
                    <div class="col-md-4">
        ...
        <div class="col-md-12 r2"
            ...
            <div id="sec" class="col-md-12" style="padding: 15px;">
                ...
                <div class="form-group">
                    ...
                    <input id="newPass2" class="form-control" type="password">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:forEach var="review" items="${reviews}">
                            <a target="_blank" href="/nyist-secondshop/review?goodId=${review.goodId}&reviewId=${review.id}">
                                    ...
                                    <c:choose>
                                        <c:when test="${review.status == 0}">
                                            <div class="col-md-1" style="padding-right: 0px">
                                                <img src="<c:url value="/statics/image/logo/yihan.png"/>" height="30px"
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:forEach var="reply" items="${replies}">
                            <a target="_blank" href="/nyist-secondshop/reply?reviewId=${reply.reviewId}&replyId=${reply.id}">
                                <div class="col-md-12 rev"
                                     style="padding-left: 0px; padding-right: 0px; margin-bottom: 5px;">
                                    <div class="col-md-11">
                                        <p></p>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:forEach var="sellGood" items="${sellGoods}">
                                <a href="/nyist-secondshop/sellerInfo?orderId=${sellGood.id}">
                                    <div class="col-md-12 rev"
...
<script>
    function submitPass(){
        ...
        if(password !== passwordConfirm){
            ...
            $.ajax({
                type:"POST",
                url:"/nyist-secondshop/user/password/edit",
