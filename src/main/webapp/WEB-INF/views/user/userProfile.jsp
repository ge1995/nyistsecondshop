...
<div class="container" style="position: relative; transform: translate(0,0)">
    <div class="col-md-9" style="float: left">
        ...
        <div class="col-md-12 r2"
            ...
            <div class="col-md-10">
                <div class="col-md-12" style="height: 60px;">
                    <h3><B>${sessionScope.user.getName()}</B></h3>
                </div>
                <div class="col-md-2" style="padding-right: 0px">
                    <p style="color: #666666; height: 20px"><B>昵称：</B></p>
                    <p style="color: #666666; height: 20px"><B>性别：</B></p>
                </div>
                ...
                <div class="col-md-2" style="padding-right: 0px">
                    <p style="color: #666666; height: 20px"><B>手机号：</B></p>
                    <p style="color: #666666; height: 20px"><B>邮箱：</B></p>
                </div>
                ...
                <div class="col-md-3">
                    <a href="/nyist-secondshop/user/userEdit?userId=${sessionScope.user.getId()}">修改个人资料</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12 r1" style="background-color: #e4e4e4;height: 40px">
            <div class="col-md-6" style="margin-top: 5px">
                <B style="color: #c4c4c4; font-size: 20px">我收藏的商品</B>
            </div>
        </div>
        <div class="col-md-12 r2" style="background-color: #f9f9f9;padding-top: 15px; padding-bottom: 15px; margin-bottom: 20px;">
            <div class="col-md-12 r" style="background-color: #ffffff;">
                <p></p>
                <p style="color: #c4c4c4; font-size: 20px; margin-bottom: 0px;" align="center"><B>我收藏的商品</B></p>
                <c:choose>
                    <c:when test="${collects.size() == 0}">
                        <div class="col-md-12" style="margin-top: 50px;" align="center">
                            <p></p>
                            <img src="<c:url value="/statics/image/logo/yihan.png"/>" width="40%" ; height="222px;">
                    ...
                    <c:otherwise>
                        ...
                        <div class="col-md-12 column" style="overflow-y:auto; height: 280px;">
                            <table class="table table-hover">
                                <tbody id="collectTable">
                                <c:forEach var="collect" items="${collects}">
                                    <tr style="color: #666666">
                                        <td style="width: 102px"><a target="_blank" href="/nyist-secondshop/goods/goodInfo?goodId=${collect.good.id}">${collect.good.id}</a></td>
        ...
        <div class="col-md-12 r1" style="background-color: #e4e4e4;height: 40px">
            <div class="col-md-6" style="margin-top: 5px">
                <B style="color: #c4c4c4; font-size: 20px">我的商品</B>
            </div>
        </div>
        <div class="col-md-12 r2" style="background-color: #f9f9f9;padding-top: 15px; padding-bottom: 15px; margin-bottom: 20px;">
            <div class="col-md-12 r" style="background-color: #ffffff;">
                <p></p>
                <p style="color: #c4c4c4; font-size: 20px; margin-bottom: 0px;" align="center"><B>我发布的商品</B></p>
                <c:choose>
                        ...
                        <div class="col-md-12 column" style="overflow-y:auto; height: 280px;">
                            <table class="table table-hover">
                                ...
                                <c:forEach var="good" items="${goods}">
                                        <tr style="color: #666666">
                                            <td style="width: 102px"><a target="_blank" href="/nyist-secondshop/goods/goodInfo?goodId=${good.id}">${good.id}</a></td>
        ...
        <div class="col-md-12 r2" style="background-color: #f9f9f9;padding-top: 15px; padding-bottom: 15px; margin-bottom: 20px;">
            <div class="col-md-12 r" style="background-color: #ffffff;">
                <p></p>
                <p style="color: #c4c4c4; font-size: 20px; margin-bottom: 0px;" align="center"><B>我所有的订单</B></p>
                <c:choose>
                    <c:when test="${orders.size() == 0}">
                        <div class="col-md-12" style="margin-top: 50px;" align="center">
                            <p></p>
                            <img src="<c:url value="/statics/image/logo/yihan.png"/>" width="40%" ; height="200px;">
                        ...
                        <div class="col-md-12 column" style="overflow-y:auto; height: 280px;">
                            <table class="table table-hover">
                                ...
                                <c:forEach var="order" items="${orders}">
                                    <tr style="color: #666666">
                                        <td style="width: 90px"><a target="_blank" href="/nyist-secondshop/user/orderInfo?orderId=${order.id}">${order.id}</a></td>
    ...
    <div id="re-bar" class="col-md-3" style="padding-left: 0px; padding-right: 0px;">
        <div class="col-md-12 r1" style="background-color: #e4e4e4; height: 40px; padding-left: 0px; padding-right: 0px;">
        ...
        <div class="col-md-12 r2" style="background-color: #f9f9f9;padding-bottom: 15px">
            <div id="review-body" class="col-md-12 r3"
                ...
                <c:choose>
                    <c:when test="${reviews.size() == 0}">
                        <div class="col-md-12" align="center" style="background-color: #ffffff; margin-top: 150px">
                            <img src="<c:url value="/statics/image/logo/yihan.png"/>" width="95%" ; height="170px;">
                            <p style="color: #c4c4c4; font-size: 16px">抱歉，暂无评论消息！</p>
                        </div>
                    </c:when>
                    <c:otherwise>
                        <c:forEach var="review" items="${reviews}">
                            <a target="_blank" href="/nyist-secondshop/user/review?goodId=${review.goodId}&reviewId=${review.id}">
                                <div class="col-md-12 rev"
                                    ...
                                    <div class="col-md-11">
                                        ...
                                        <p><B style="color: #2aabd2">${review.fromUser}</B>&nbsp;评论了你的商品</p>
                                    </div>
                                    <c:choose>
                                        <c:when test="${review.status == 0}">
                                            <div class="col-md-1" style="padding-right: 0px">
                                                <img src="<c:url value="/statics/image/logo/new_message.png"/>" height="30px"
                                                     width="25px" align="right">
                                            </div>
                                        </c:when>
                                    </c:choose>
                                </div>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:forEach var="reply" items="${replies}">
                            <a target="_blank" href="/nyist-secondshop/user/reply?reviewId=${reply.reviewId}&replyId=${reply.id}">
                                <div class="col-md-12 rev"
                                     style="padding-left: 0px; padding-right: 0px; margin-bottom: 5px;">
                                    <div class="col-md-11">
                                        <p></p>
                                        <p style="color: #c4c4c4;">${reply.uploadDate}</p>
                                        <p><B style="color: #2aabd2">${reply.fromUser}</B>&nbsp;回复了你的消息</p>
                                    </div>
                                    <c:choose>
            ...
            <div id="adv-bar" class="col-md-12"
                ...
                <div class="col-md-12" align="center">
                    <B style="font-size: 16px; color: #c4c4c4">卖出的商品</B>
                </div>
                <div class="col-md-12" style="overflow-y:auto; height: 450px; padding: 5px;  background-color: #ffffff;" >
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:forEach var="sellGood" items="${sellGoods}">
                                <a href="/nyist-secondshop/user/sellerInfo?orderId=${sellGood.id}">
                                    <div class="col-md-12 rev"
                                         style="padding: 10px; margin-bottom: 5px;">
                                        <div class="col-md-11" style="padding: 0px;">
                                            <p></p>
                                            <p style="color: #c4c4c4;">${sellGood.submitDate}</p>
                                            <p><B style="color: #2aabd2">${sellGood.customer}</B>&nbsp;购买了你的商品&nbsp;<B style="color: #2aabd2">${sellGood.goodName}</B></p>
                                        </div>
                                    </div>
                                </a>
                            </c:forEach>
...
<script>
    function deleteCollect(collectId) {
        $.get("/nyist-secondshop/collect/delete/"+collectId+"&"+${sessionScope.user.id}, function (data) {
            if (data === false){
                alert("未知原因，删除失败！");
            } else {
                ...
                $.each(data, function (i, type) {
                    ...
                    var collect = "<tr style=\"color: #666666\">"+
                        "<td style=\"width: 102px\"><a target='_blank' href='/nyist-secondshop/goods/goodInfo?goodId="+collectGoodId+"'>"+collectGoodId+"</a></td>"+
