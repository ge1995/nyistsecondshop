    ...
    <div class="col-md-9" style="float: left">
        ...
        <div class="col-md-12 r2" style="background-color: #f9f9f9;padding-top: 15px; padding-bottom: 15px; margin-bottom: 20px">
            <div class="col-md-2" style="padding-left: 0px; padding-right: 0px;">
                <img src="<c:url value="${user.photoUrl}"/>" width="128px" height="128px">
            </div>
            <div class="col-md-10">
        ...
        <div class="col-md-12 r1" style="background-color: #e4e4e4;height: 40px">
            <div class="col-md-6" style="margin-top: 5px">
                <B style="color: #c4c4c4; font-size: 20px">发布的商品</B>
            </div>
        </div>
        <div class="col-md-12 r2" style="background-color: #f9f9f9;">
            <div class="col-md-12" style="margin-top: 15px; margin-bottom: 15px; padding: 15px 15px 15px 5px; background-color: #ffffff">
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:forEach var="userGood" items="${userGoods}">
                            <a target="_blank" href="/nyist-secondshop/goods/goodInfo?goodId=${userGood.id}">
                                <div class="c col-md-4">
                                    <div class="a col-md-12">
                                        ...
                                        <p style="color: red;text-align: right"><B>价格：${userGood.prise}￥</B></p>
                                    </div>
                                </div>
                            </a>
                        </c:forEach>
