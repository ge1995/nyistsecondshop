...
import com.nyist.secondshop.mappers.GoodMapper;
...
public class GoodService {
    ...
    @Transactional
    public List<Good> getGoodsBySearchAndType(String searchText, Integer secondTypeId, int offset, int limit) {
    ...
    @Transactional
    public int getGoodsBySearchAndTypeCount(String searchText, Integer secondTypeId) {
        if (!searchText.equals("")) {
            searchText = "%" + searchText + "%";
